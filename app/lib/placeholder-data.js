...
const posts = [
  {
    ...
    title:
      "Building Bridges: Exploring Philosophical Analogies in Test-Driven Development (TDD) and Figma Prototyping",
    ...
    fields: [
      ...
      },
      {
        ...
        content:
          "Both TDD and Figma prototyping share a fundamental principle – iteration. In TDD, developers iteratively write tests and refine code, while in Figma, designers iterate through prototypes to refine the user experience. This iterative nature aligns with Nietzsche's concept of eternal recurrence, where the cyclical nature of existence invites continual refinement and improvement.",
      },
      {
